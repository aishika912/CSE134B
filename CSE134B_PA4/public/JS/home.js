...
function displaySticksFn(data) {
	...
	own_average.textContent = "So far you have spent $" + num + " on lipsticks.";
	document.getElementById("data-info").appendChild(own_average);

	var want_average = document.createElement("h4");
	console.log("want total = " + want_total);
	console.log("want number = " + want_number);
	var num2 = want_total / want_number;
	want_average.textContent = "Your wish list costs $" + num2 + ".";
